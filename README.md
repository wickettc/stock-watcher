This project will be a stock market watching application created with VueJS and utilizing the Alpha Vantage API. I plan on using vuex to manage state and the vue router.
